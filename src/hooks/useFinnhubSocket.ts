...
// 	const [prices, setPrices] = useState<PriceMapProps>({} as PriceMapProps);
...
// 				latestRef.current[trade.s] = trade.p;
// 			}

// 			//This is for not upgrading the UI every time we received data
// 			const now = Date.now();
